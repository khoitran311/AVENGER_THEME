            ...
            {userData && LinkStarIcons && (
                <div className="linkstar">
                    <div className="relative w-full h-full group">
                        ...
                        <div className="relative grid min-h-full backdrop-blur-2xl bg-cover bg-gradient-to-r from-pink-500 to-blue-500">
                            <div className="relative z-10 flex flex-col h-full text-stone-700">
                                <div>
                                    {userData.cover_img_absolute ? (
                                        <div className="w-full aspect-[5/2] heart sm:aspect-[4] xl:aspect-[5/1] px-3 pt-3 mx-auto sm:px-6 sm:pt-6 lg:px-8 lg:pt-8 xl:px-36 xl:py-0">
                                            <img
                                                src={userData.cover_img_absolute}
                                                alt={`${userData.username}'s cover`}
                                                className="object-cover object-center heart w-full h-full bg-gray-100 shadow-md rounded-2xl shadow-black/10 xl:rounded-t-none"
                                            />
                                        </div>
                                    ) : (
                                ...
                                <div className="w-full max-w-screen-sm mx-auto mb-6 -mt-14 md:-mt-[3.75rem]">
                                    ...
                                    <div className="w-full h-72 mt-10 lg:hidden md:hidden sm:block">
                                        <img
                                            className="w-full h-full"
                                            src="https://i.pinimg.com/originals/0c/57/dd/0c57dd57539635c63467bbcdbf0611ed.gif"
                                            alt=""
                                        ></img>
                                    </div>
                                </div>
